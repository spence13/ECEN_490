// Generated by gencpp from file christiauto_robaldo/RobotState.msg
// DO NOT EDIT!


#ifndef CHRISTIAUTO_ROBALDO_MESSAGE_ROBOTSTATE_H
#define CHRISTIAUTO_ROBALDO_MESSAGE_ROBOTSTATE_H
...
struct RobotState_
{
  ...
  typedef boost::shared_ptr< ::christiauto_robaldo::RobotState_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::christiauto_robaldo::RobotState_<ContainerAllocator> const> ConstPtr;

}; // struct RobotState_

typedef ::christiauto_robaldo::RobotState_<std::allocator<void> > RobotState;

typedef boost::shared_ptr< ::christiauto_robaldo::RobotState > RobotStatePtr;
typedef boost::shared_ptr< ::christiauto_robaldo::RobotState const> RobotStateConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::christiauto_robaldo::RobotState_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::christiauto_robaldo::RobotState_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::christiauto_robaldo::RobotState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::christiauto_robaldo::RobotState_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::christiauto_robaldo::RobotState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::christiauto_robaldo::RobotState_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::christiauto_robaldo::RobotState_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::christiauto_robaldo::RobotState_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::christiauto_robaldo::RobotState_<ContainerAllocator> >
{
  ...
  static const char* value(const ::christiauto_robaldo::RobotState_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x9ebf5c3bc78dc310ULL;
  static const uint64_t static_value2 = 0xa9067120721e6ec8ULL;
};

template<class ContainerAllocator>
struct DataType< ::christiauto_robaldo::RobotState_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::christiauto_robaldo::RobotState_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::christiauto_robaldo::RobotState_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::christiauto_robaldo::RobotState_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::christiauto_robaldo::RobotState_<ContainerAllocator>& v)
  {
    s << indent << "vision_x: ";
...
#endif // CHRISTIAUTO_ROBALDO_MESSAGE_ROBOTSTATE_H
