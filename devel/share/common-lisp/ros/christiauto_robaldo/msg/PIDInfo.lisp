...
(cl:defmethod cl:initialize-instance :after ((m <PIDInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PIDInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name christiauto_robaldo-msg:<PIDInfo> is deprecated: use christiauto_robaldo-msg:PIDInfo instead.")))

(cl:ensure-generic-function 'error-val :lambda-list '(m))
(cl:defmethod error-val ((m <PIDInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader christiauto_robaldo-msg:error-val is deprecated.  Use christiauto_robaldo-msg:error instead.")
  (error m))

(cl:ensure-generic-function 'desired-val :lambda-list '(m))
(cl:defmethod desired-val ((m <PIDInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader christiauto_robaldo-msg:desired-val is deprecated.  Use christiauto_robaldo-msg:desired instead.")
  (desired m))

(cl:ensure-generic-function 'actual-val :lambda-list '(m))
(cl:defmethod actual-val ((m <PIDInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader christiauto_robaldo-msg:actual-val is deprecated.  Use christiauto_robaldo-msg:actual instead.")
  (actual m))
