...
(cl:defmethod cl:initialize-instance :after ((m <BallState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BallState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name christiauto_robaldo-msg:<BallState> is deprecated: use christiauto_robaldo-msg:BallState instead.")))
