...
if(NOT "/home/robot/catkin_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'christiauto_robaldo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robot/catkin_ws/src/christiauto_robaldo/${idir}'.  Ask the maintainer 'Nathan Wohlgemuth <n.e.wohlgemuth@gmail.com>' to fix it.")
    endif()
